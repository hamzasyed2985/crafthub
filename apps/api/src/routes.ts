...
import { reviewsRouter } from './modules/catalog/reviews.js';
import { searchRouter } from './modules/catalog/search.js';
...
import { adminCategoriesRouter } from './modules/admin/categories.js';
import { adminInboxRouter } from './modules/admin/inbox.js';
...
router.use('/api/v1/admin', adminCategoriesRouter);
router.use('/api/v1/admin', adminInboxRouter);
